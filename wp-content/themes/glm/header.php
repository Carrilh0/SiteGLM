...
<head>
    ...
    <link href="<?php echo $path?>/css/bulma.css" rel="stylesheet">
    <link href="<?php echo $path?>/css/header.css" rel="stylesheet">
    <link href="<?php echo $path?>/css/body.css" rel="stylesheet">
...
<nav class="navbar" role="navigation" aria-label="main navigation">
        ...
        <div id="navbarBasicExample" class="navbar-menu">
            <div class="navbar-start">
                <a class="navbar-item">
                    <img src="<?php echo $path?>/img/logo_glm.png" width="112" height="522">
                </a>
                <ul>
            ...
            Blog
                ...
                <div class="nav-icons">
                    <a class="navbar-item" href="https://www.facebook.com/jabutiazulbrasil/">
                        <img class="image is-16x16" src="<?php echo $path?>/img/icon_face.png" width="112" height="522">
                    </a>
                    <a class="navbar-item" href="https://www.instagram.com/jabutiazulbrasil/">
                        <img class="image is-16x16" src="<?php echo $path?>/img/icon_insta.png" width="112" height="522">
                    </a>
                    <a class="navbar-item" href="https://www.youtube.com/channel/UCsD0kd1U87UQ-Rd42Heir9g">
                        <img class="image is-16x16" src="<?php echo $path?>/img/icon_yt.png" width="112" height="522">
                    </a>
                    </li>
                </div>
