...
<head>
    ...
    <link href="<?php echo $path?>/css/form.css" rel="stylesheet">
            ...
            <div class="previews">
                <a href="<?php echo $path?>/downloads/Regulamento.pdf" target="_blank">
                    <div class="preview">
                        ...
                        <div class="image">
                            <img src="<?php echo $path?>/img/regulamento.jpg">
                        </div>
                    </div>
                </a>
                <a href="<?php echo $path?>/downloads/FAQ.pdf" target="_blank">
                    <div class="preview">
                        <div class="name">
                            FAQ
                        </div>
                        <div class="image">
                            <img src="<?php echo $path?>/img/faq.jpg">
                        </div>
                    </div>
                </a>
            </div>
